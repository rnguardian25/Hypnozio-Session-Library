...
const DATA = [
  {
    ...
    programs: {
      en: [
        { title: 'Weight Loss Introduction',         dur: '22 min', size: '— MB', url: '#' },
        { title: 'Calorie Burning Boost',             dur: '18 min', size: '— MB', url: '#' },
        { title: 'Healthy Eating Habits',             dur: '25 min', size: '— MB', url: '#' },
        { title: 'Motivation & Mindset Booster',      dur: '20 min', size: '— MB', url: '#' },
        { title: 'Deep Relaxation for Weight Loss',   dur: '30 min', size: '— MB', url: '#' },
      ],
      de: [
  ...
  progs.forEach((p, i) => {
    ...
    card.innerHTML = `
      <div class="card-inner">
        ...
        <!-- Thumbnail: only duration tag remains -->
